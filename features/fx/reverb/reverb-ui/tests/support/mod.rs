//! Shared fixture for the reverb editor's headless tests.
//!
//! Mounts `reverb_ui::control_view::App` — the exact Dioxus surface the
...
/// - `ReverbUi`, the params + meters the editor consumes.
...
pub fn mount_sized(width: u32, height: u32) -> Fixture {
    mount_with(Arc::new(ReverbParams::default()), width, height)
}
...
pub fn mount_with(params: Arc<ReverbParams>, width: u32, height: u32) -> Fixture {
