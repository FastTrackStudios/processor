...
/// Shimmer (variant 0): 0.56 s … 12.38 s.
const SHIMMER_0: DecayTable = DecayTable {
    ...
    t60: &[0.556, 0.590, 0.628, 0.663, 0.708, 0.744, 0.788, 0.849, 0.924, 1.021, 1.143, 1.292, 1.485, 1.768, 2.132, 2.706, 3.550, 4.546, 7.508, 9.427, 12.381],
};
